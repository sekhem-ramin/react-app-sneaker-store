...
export default function Cart() {
  //Since we are using React Link components no longer need this hook
  ...
  // Saving and Memoizing the cart length check to prevent re-renders
  const isCartEmpty = useMemo(() => cart.length === 0, [cart.length]);

  const handleClick = () => {
    navigation("/home", { state: { username: "sekhem" } });
  };

...
export default function Dropdown({
  ...
  return (
    <div className="flex items-center gap-2 justify-end pr-12 flex-1 font-primary">
      ...
      <select
        className="px-3 py-2 text-base border rounded-md transition border-primary dark:border-light focus:ring focus:ring-dark dark:focus:ring-lighter focus:outline-none text-gray-800 dark:text-light"
        value={selectedValue}

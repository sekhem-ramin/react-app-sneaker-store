  ...
  useEffect(() => {
    if (actionData?.success) {
      if (actionData.profileData.emailUpdated) {
        ...
        // We are updating the user object in auth context and localStorage
        if (actionData.profileData) {
          const updatedUser = {
            ...profileData, //previous value
            ...actionData.profileData, // copying the updated field values
          };
          //Update these values in the context
          dispatch(
            loginSuccess({
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              required
              minLength={2} //Stripe API only permits two characters for country code
              maxLength={2}
